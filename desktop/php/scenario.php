					...
					<div class="col-sm-6">
						<form class="form-horizontal">
							<fieldset>
								...
								<legend><i class="fas fa-play-circle"></i> {{Actions de déclenchement}}</legend>
              ...
              <div id="md_addElement" class="jeeDialog jeeDialogPrompt jeeDialogNoCloseBackdrop" style="display:none;">
                ...
                <div class="jeeDialogContent">
                  ...
                  <div class="addElementTypeDescriptionPanel">
                    <div class="addElementTypeDescriptionTitle">
                      <i class="fas fa-info-circle"></i>
                      <span id="addElementTypeSelectedName">
                        {{Si/Alors/Sinon}}
                      </span>
                    </div>
                    <div class="addElementTypeDescriptionText">
                      <div class="addElementTypeDescription if">
                      ...
                      <div class="addElementTypeDescription action" style="display:none;">
                        {{Permet de lancer une action sur un de vos modules, scénarios ou autre. Par exemple : Passer votre sirène sur ON.}}
                      </div>
                      <div class="addElementTypeDescription for" style="display:none;">
                      ...
                      <div class="addElementTypeDescription while" style="display:none;">
...
include_file('desktop', 'scenario', 'css');
